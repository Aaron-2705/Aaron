...
// Adapted from React Bits <Aurora /> (ogl, WebGL2). Ported to TS; default
// color stops tuned to the steel theme. Ambient full-bleed background.
...
export default function Aurora({
  colorStops = ["#1b2a6b", "#3f74ff", "#8aa9ff"],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
  className = "",
  ...
  return <div ref={ctnDom} className={`h-full w-full ${className}`} aria-hidden="true" />;
}
